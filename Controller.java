...
/**
 * @Author Robert Jacob, Patryk Stefanski.
 * @Version 1.0 10/05/2021
 *
 * GraphAnalyzer - graph navigation application for map of Waterford city, route finding abilities using dijkstra algorithm and breadth first search
 * for finding routes with graphical feedback on JavaFX GUI.
 */
...
public class Controller {
    ...
    /**
     * clears and populates all combo boxes in GUI
     */
    ...
    /**
     * adds labels to pane from graphlist
     */
...
//            }
    ...
    /**
     * changes map image to black and white in order to search paths using dijkstra
     * @param blankImage blank vector image of waterford
     * @return image with roads white and everything else black
     */
    ...
    /**
     * adds desired start and end points to arraylist which is processed by dijkstra to return the cheapest path which is then drawn using bfs
     */
    ...
    /**
     * sets start and end points to be used in breadth first search algorithm
     */
     ...
     * @param image black and white map image
    ...
    /**
     * draws circles on pane for each landmark or point
     * @param x coord
     * @param y coord
     * @param selection type of point
     */
    ...
    /**
     * adds points to be saved to text file
     */
    ...
    /**
     * draws points from text file on pane
     */
